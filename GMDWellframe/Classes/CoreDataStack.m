...
- (void)saveContext
{
    ...
    if (managedObjectContext != nil) {
        if ([managedObjectContext hasChanges] && ![managedObjectContext save:&error]) {
            ...
            NSString *message = [NSString stringWithFormat:@"Something went wrong: %@. Please try again later", [error localizedDescription]];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BookmarkEntry.sqlite"];
